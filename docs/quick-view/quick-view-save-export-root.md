...
> 来源: https://jimmer.deno.dev/zh/docs/quick-view/save/export/root
...
```
   ...
   和[查询任意形状/暴露功能/返回输出DTO](/zh/docs/quick-view/fetch/export/dto)一文中的Output DTO不同，这里输入DTO采用`input`修饰符
...
- ❷ 和[查询任意形状/暴露功能/返回输出DTO](/zh/docs/quick-view/fetch/export/dto)一文中的Output DTO不同，
...
### 编写HTTP服务[​](#编写http服务-1 "编写HTTP服务的直接链接")
...
[编辑此页](https://github.com/babyfish-ct/jimmer-doc/edit/main/i18n/zh/docusaurus-plugin-content-docs/current/quick-view/save/export/root.mdx)
