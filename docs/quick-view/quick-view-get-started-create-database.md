...
> 来源: https://jimmer.deno.dev/zh/docs/quick-view/get-started/create-database
...
完整的SQL文件，请参见<https://github.com/babyfish-ct/jimmer-examples/blob/main/env-with-cache/maxwell/jimmer-demo.sql>

## 创建数据库[​](#创建数据库 "创建数据库的直接链接")
...
[  编辑此页](https://github.com/babyfish-ct/jimmer-doc/edit/main/i18n/zh/docusaurus-plugin-content-docs/current/quick-view/get-started/create-database.mdx)
