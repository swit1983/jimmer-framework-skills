...
## 多对一关联`Book.store`[​](#多对一关联bookstore "多对一关联bookstore的直接链接")
...
## 一对多关联`BookStore.books`[​](#一对多关联bookstorebooks "一对多关联bookstorebooks的直接链接")
...
## 多对多关联`Author.books`[​](#多对多关联authorbooks "多对多关联authorbooks的直接链接")
...
## 完善TreeNode的定义[​](#完善treenode的定义 "完善TreeNode的定义的直接链接")
...
2. 不可变性
   ...
   如何创建和“修改”不可变对象的细节，请参考[不可变性/方案](/zh/docs/object/immutable/solution)
...
[编辑此页](https://github.com/babyfish-ct/jimmer-doc/edit/main/i18n/zh/docusaurus-plugin-content-docs/current/quick-view/get-started/define-entity.mdx)
