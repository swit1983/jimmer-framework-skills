...
## Jimmer SQL DSL[​](#jimmer-sql-dsl "Jimmer SQL DSL的直接链接")
...
> 至于2，有兴趣者可参见[Native表达式](/zh/docs/query/native-sql)
...
### 定义动态动态表连接[​](#定义动态动态表连接 "定义动态动态表连接的直接链接")
...
[编辑此页](https://github.com/babyfish-ct/jimmer-doc/edit/main/i18n/zh/docusaurus-plugin-content-docs/current/quick-view/dsl/feature.mdx)
