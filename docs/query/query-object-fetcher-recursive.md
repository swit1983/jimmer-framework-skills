...
> 来源: https://jimmer.deno.dev/zh/docs/query/object-fetcher/recursive
...
## 控制每个节点是否递归[​](#控制每个节点是否递归 "控制每个节点是否递归的直接链接")
...
[编辑此页](https://github.com/babyfish-ct/jimmer-doc/edit/main/i18n/zh/docusaurus-plugin-content-docs/current/query/object-fetcher/recursive.mdx)
