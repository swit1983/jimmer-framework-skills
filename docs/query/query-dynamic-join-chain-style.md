...
> 来源: https://jimmer.deno.dev/zh/docs/query/dynamic-join/chain-style
...
- Kotlin DSL
  ...
  这个细节会在[Kotlin表连接特有功能](/zh/docs/query/dynamic-join/kotlin-join)中详细讨论。

[编辑此页](https://github.com/babyfish-ct/jimmer-doc/edit/main/i18n/zh/docusaurus-plugin-content-docs/current/query/dynamic-join/chain-style.mdx)
