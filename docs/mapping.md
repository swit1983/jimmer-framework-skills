...
* 对于有ORM经验 *(尤其是JPA经验)* 的读者，可以快速阅读。
  ...
  + 高级映射
    ...
    - [远程关联](/zh/docs/mapping/advanced/remote)
    - [Key](/zh/docs/mapping/advanced/key)
...
[编辑此页](https://github.com/babyfish-ct/jimmer-doc/edit/main/i18n/zh/docusaurus-plugin-content-docs/current/mapping/index.md)
