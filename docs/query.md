...
在这个章节中，我们将会在不考虑[缓存](/zh/docs/cache)的情况下介绍Jimmer中各种查询。
...
[编辑此页](https://github.com/babyfish-ct/jimmer-doc/edit/main/i18n/zh/docusaurus-plugin-content-docs/current/query/index.md)
